...
| Frontend | `FrontendXssDataExposureTest`, `FrontendNavbarVisibilityTest`, `CsrfCookieAttributesTest` | DOM clobbering, XSS sinks, scripts inline, tokens em storage, tracking code em URL, categorias compativeis com o backend, tracking publico sem metadados de anexos, navs escondidas, CSRF cookie. |
