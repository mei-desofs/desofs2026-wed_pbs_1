...
| Tracking code anonimo          | `TrackingCode`, `ReportService`                                                  | `SecureRandom` + Base64 URL-safe; hash BCrypt para verificação.                            | Código gerado pela aplicação; hash persistido.                                     | Implementado                             |
...
| Uploads e pacotes de evidencia | `FileStorageService`, `CasePackageService`                                       | SHA-256 para hashes de ficheiros/pacotes.                                                  | Sem segredo; deteção de alteração.                                                 | Implementado                             |
